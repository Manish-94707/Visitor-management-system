...
<div class="wrapper">
    ...
    <?php $page='visitor-management'; include 'includes/sidebar2.php'?>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="visname" id="visname" value="<?php  echo $row['VisitorName'];?>" >
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="WhomtoMeet" id="WhomtoMeet" value="<?php  echo $row['WhomtoMeet'];?>" >
                    </div>

                    <div class="form-group">
                        <label>Entry Date and Time</label>
                        <input type="text" class="form-control" name="reason" id="reason" value="<?php  echo $row['EnterDate'];?>" >
                    </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="mobilenumber" id="mobilenumber" value="<?php  echo $row['MobileNumber'];?>" >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="device" id="device" value="<?php  echo $row['device'];?>" >
                    </div>

                    <div class="form-group">
                        <label>Reason</label>
                        <input type="text" class="form-control" name="Reason" id="Reason" value="<?php  echo $row['Reason'];?>" >
                    </div>
