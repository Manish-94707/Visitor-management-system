...
<div class="wrapper">
    ...
    <?php $page='reports'; include 'includes/sidebar2.php'?>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td><a href="action-visitor2.php?editid=<?php echo $row['ID'];?>" title="View Full Details"><i class="fa fa-eye" style="color:green;"></i></a></td>
