            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">
                        ...
                        <br>  <br>  <H6>It seems you are already registered </H6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Auto-fill the mobile number if provided -->
                                <input type="text" class="form-control" name="mobilenumber" id="mobilenumber" <?php if(isset($_GET['mobilenumber'])) echo "value='".$_GET['mobilenumber']."'"; ?> required pattern="[0-9]{10}" required maxlength="10" title="Please enter a 10-digit numeric contact number" oninput="restrictToNumeric(this)" readonly>
                            ...
                            <div class="form-group">
                                <input type="submit" name="fetch_data" value="Continue" class="btn btn-submit btn-block" >
                            </div>
                        </form>
                        ...
                        if(isset($_POST['fetch_data'])) {
                            ...
                            if(isset($_POST['mobilenumber'])) {
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    ...
                                    // Submit button
                                    echo "<div class='form-group'>";
                                    echo "<input type='submit' name='update_data' value='Check in' class='btn btn-submit btn-block' onclick='checkIn()'>";
                                    echo "</div>";
